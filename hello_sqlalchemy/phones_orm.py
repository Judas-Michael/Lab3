...
# echo=True turns on (lots of!) logging. echo=False turns SQLAlchemy logging off.
...
# The phone is pending - not yet saved. It won't be saved to the DB until
# the session is committed, or closed
...
print(search_session.query(Phone).filter_by(id=4).one_or_none()) # Phone with id = 4 data
